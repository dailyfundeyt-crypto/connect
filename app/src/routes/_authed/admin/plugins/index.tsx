    ...
    >
      ...
      {plugins.isPending ? null : plugins.error ? (
        ...
        <>
          ...
          <PageSection
            description="External vendor directories stay off on this local deployment."
            title="More apps"
          >
            <PageRows>
              <Item data-testid="plugin-composio" size="sm">
                ...
                <ItemContent>
                  ...
                  <ItemDescription>
                    Disabled locally. Connect does not dial Composio or other
                    external app catalogues.
                  </ItemDescription>
                </ItemContent>
              </Item>
            </PageRows>
