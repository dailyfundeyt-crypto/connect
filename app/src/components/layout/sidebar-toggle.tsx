...
export function useSidebarToggleVisible(): boolean {
  ...
  const { isMobile, open } = sidebar;
  // Mobile sheet starts closed — always keep a visible opener.
  if (isMobile) return true;
  // Desktop: when the sidebar is open, AppSidebar / LevelChrome already show
  // the labeled „Einklappen“ control. Only draw this icon as the way back in.
  return !open;
}
